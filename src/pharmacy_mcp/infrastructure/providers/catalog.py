...
PROVIDER_CATALOG: tuple[ProviderDescriptor, ...] = (
    ...
    ProviderDescriptor(
        id="pubmed",
        title="NCBI PubMed E-utilities",
        kind=ProviderKind.PUBLIC_API,
        state=ProviderState.READY,
        capabilities=(C.LITERATURE,),
        documentation_url="https://www.ncbi.nlm.nih.gov/books/NBK25497/",
        enabled_by_default=True,
        notes="Returns citation metadata and PubMed links, not full article text.",
    ),
    ProviderDescriptor(
        id="clinical-trials-gov",
        title="ClinicalTrials.gov API v2",
        kind=ProviderKind.PUBLIC_API,
        state=ProviderState.READY,
        capabilities=(C.CLINICAL_TRIAL, C.INDICATION),
        documentation_url="https://clinicaltrials.gov/data-api/api",
        enabled_by_default=True,
    ),
    ProviderDescriptor(
        id="chembl",
        title="EMBL-EBI ChEMBL REST API",
        kind=ProviderKind.PUBLIC_API,
        state=ProviderState.READY,
        capabilities=(C.IDENTITY, C.CHEMISTRY, C.TARGET, C.BIOACTIVITY),
        documentation_url="https://www.ebi.ac.uk/chembl/api/data/docs",
        enabled_by_default=True,
    ),
    ProviderDescriptor(
        id="open-targets",
        ...
        kind=ProviderKind.PUBLIC_API,
        state=ProviderState.READY,
        capabilities=(C.TARGET, C.INDICATION),
        documentation_url=(
