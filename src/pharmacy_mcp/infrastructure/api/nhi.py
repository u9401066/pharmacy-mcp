...
NHI_COVERAGE_RULES: dict[str, dict[str, Any]] = {
    ...
    "warfarin": {
        ...
        "is_covered": True,
        "coverage_type": "一般給付",
        "indications": ["心房顫動", "深部靜脈栓塞", "肺栓塞", "機械瓣膜置換術後"],
    ...
    "clopidogrel": {
        ...
        "indications": ["急性冠心症候群", "經皮冠狀動脈介入術後"],
    ...
    "aspirin": {
        ...
        "is_covered": True,
        "coverage_type": "一般給付",
        "indications": ["解熱鎮痛", "心血管疾病預防", "急性冠心症候群"],
        "restrictions": "無",
        "prior_authorization": False,
    ...
    "rivaroxaban": {
        ...
        "is_covered": True,
        "coverage_type": "限特定條件給付",
        "indications": ["非瓣膜性心房顫動", "深部靜脈栓塞治療與預防", "肺栓塞治療"],
    ...
    "atorvastatin": {
        ...
        "is_covered": True,
        "coverage_type": "一般給付",
        "indications": ["高膽固醇血症", "混合性高脂血症", "心血管疾病預防"],
    ...
    "omeprazole": {
        ...
        "is_covered": True,
        "coverage_type": "限特定條件給付",
        "indications": ["消化性潰瘍", "胃食道逆流", "Zollinger-Ellison症候群"],
    ...
    "amoxicillin": {
        ...
        "is_covered": True,
        "coverage_type": "一般給付",
        "indications": ["呼吸道感染", "泌尿道感染", "幽門桿菌除菌"],
        "restrictions": "無",
        "prior_authorization": False,
    ...
    "pregabalin": {
        ...
        "is_covered": True,
        "coverage_type": "限特定條件給付",
        "indications": ["帶狀皰疹後神經痛", "糖尿病周邊神經痛", "纖維肌痛症"],
    ...
    "rituximab": {
        ...
        "is_covered": True,
        "coverage_type": "事前審查",
        "indications": ["非乎杰金氏淋巴瘤", "慢性淋巴性白血病", "類風濕性關節炎"],
    ...
    "adalimumab": {
        ...
        "is_covered": True,
        "coverage_type": "事前審查",
        "indications": ["類風濕性關節炎", "乾癬", "克隆氏症", "僵直性脊椎炎"],
    ...
    "etanercept": {
        ...
        "is_covered": True,
        "coverage_type": "事前審查",
        "indications": ["類風濕性關節炎", "乾癬性關節炎", "僵直性脊椎炎"],
    ...
    "osimertinib": {
        ...
        "is_covered": True,
        "coverage_type": "事前審查",
        "indications": ["T790M陽性非小細胞肺癌", "EGFR突變陽性非小細胞肺癌一線治療"],
    ...
    "pembrolizumab": {
        ...
        "is_covered": True,
        "coverage_type": "事前審查",
        "indications": ["黑色素瘤", "非小細胞肺癌", "典型乎杰金氏淋巴瘤"],
